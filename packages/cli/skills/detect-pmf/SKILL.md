...
3. Build the smallest useful catalog. Prefer 3-8 outcome events and stable,
   non-PII properties. Every event must correspond to an authoritative business
   transition.
...
other credentials. Keep property names and values low-cardinality.
