 ...
 *
 * Why a single file: browser capture is the most user-visible
 * surface and the file is the contract. Splitting this would just shift the surface to
...
/**
 * React component that boots Volato browser capture once per page load.
