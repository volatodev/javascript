...
\`volato-sveltekit\`, \`volato-astro\`, \`volato-node\`,
...
2.70 SSR on the official standalone Node adapter; Astro 7.2 on-demand on the
official standalone Node adapter; and Node.js runtime capture for conventional servers,
