...
try {
  ...
  for (const required of [
    ...
    "skills/volato-vite-react/assets/runtime/browser.ts",
    "skills/volato-vite-react/assets/runtime/react.tsx",
    "skills/volato-vite-react/assets/runtime/artifact.ts",
    "skills/volato-vite-react/assets/runtime/vite.ts",
    "skills/volato-vite-react/assets/runtime/webpack.ts",
